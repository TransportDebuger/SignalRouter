...
@brief Абстракция над системными вызовами POSIX для инкапсуляции и тестируемости.
@version 1.0.0
@date 2026-07-20
*/
...
/**
@class ISystemCalls
@brief Интерфейс абстракции системных вызовов ядра Linux (epoll, signalfd, sigprocmask).
*/
class ISystemCalls {
public:
    ...
    */
    virtual int EpollWait(int epfd, struct epoll_event* events, int maxevents, int timeout) = 0;
